"""Publish the nudity gallery: optimize, stage and push, in one pass.

    python gallery/nudity/publish.py --source <dir>              # add missing only
    python gallery/nudity/publish.py --source <dir> --overwrite  # also replace existing
    python gallery/nudity/publish.py --source <dir> --dry-run    # report, change nothing

=============================================================================
 THIS FILE IS ONE OF THREE NEAR-IDENTICAL COPIES
 gallery/nudity/publish.py - gallery/archetypes/publish.py -
...
GALLERY_KIND = "nudity"
GALLERY_TITLE = "nudity look"
PAGE_FILES = ["index.html", "style.css", "gallery.js",
              "Krea2_ExpliciteIdentityForge_NudityCycle.json"]
# ============================================================================
