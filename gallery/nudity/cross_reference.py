"""Report which NUDITY entries still need a sample image.

    python gallery/nudity/cross_reference.py                 # against gh-pages
    python gallery/nudity/cross_reference.py --images <dir>  # against a folder
...
=============================================================================
 ...
 gallery/nudity/ - gallery/archetypes/ - gallery/creatures/
