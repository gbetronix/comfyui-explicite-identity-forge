"""Report which ARCHETYPE entries still need a sample image.

    python gallery/archetypes/cross_reference.py                 # against gh-pages
    python gallery/archetypes/cross_reference.py --images <dir>  # against a folder
