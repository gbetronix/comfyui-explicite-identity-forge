"""Publish the fetish gallery: optimize, stage and push, in one pass.

    python gallery/fetish/publish.py --source <dir>              # add missing only
    python gallery/fetish/publish.py --source <dir> --overwrite  # also replace existing
    python gallery/fetish/publish.py --source <dir> --dry-run    # report, change nothing

=============================================================================
 THIS FILE IS ONE OF THREE NEAR-IDENTICAL COPIES
 gallery/fetish/publish.py - gallery/archetypes/publish.py -
...
GALLERY_KIND = "fetish"
GALLERY_TITLE = "fetish act"
PAGE_FILES = ["index.html", "style.css", "gallery.js",
              "Krea2_ExpliciteIdentityForge_FetishCycle.json"]
# ============================================================================
