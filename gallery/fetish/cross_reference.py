"""Report which FETISH entries still need a sample image.

    python gallery/fetish/cross_reference.py                 # against gh-pages
    python gallery/fetish/cross_reference.py --images <dir>  # against a folder
...
=============================================================================
 ...
 gallery/fetish/ - gallery/archetypes/ - gallery/creatures/
